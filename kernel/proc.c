...
// when freeing a kernel page, the physical address content should be presered
// because, this is the kernel page which contains kernel data such as KERNBASE
// not like user process table only contains process related data.
// so free kernel page table, only free its PTE (page table entries)
void
